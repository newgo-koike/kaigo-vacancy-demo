# 260911 尼崎市データ追加版: Desktopのxlsxから kaigo-import-data-260911.js を生成する。
# 形式は260723版（11列）と同一。違いは住所が「兵庫県」始まりで prefecture='兵庫県' になる点のみ。
# 生成物は kaigo-xlsx-import-260911.html から window.NEW_FACILITIES_260911 として読み込まれる。
import json
import re
import openpyxl
...
CITY_FILES = [
    ('尼崎市', '/Users/yugo/Desktop/尼崎市の介護施設データ.xlsx'),
]
...
def main():
    ...
    out_path = 'tools/kaigo-import-data-260911.js'
    with open(out_path, 'w', encoding='utf-8') as f:
        f.write('// 260911 兵庫3市（伊丹・川西・宝塚）→ Firestore facilities 追加分\n')
        ...
        f.write('window.NEW_FACILITIES_260911 = ')
